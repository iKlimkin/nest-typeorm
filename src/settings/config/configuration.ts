const getConfig = (
  ...
  pg: {
    ...
    type: environmentVariables.DB_TYPE as 'postgres',
    synchronize: Boolean(environmentVariables.DB_SYNCHRONIZE),
    autoLoadEntities:  Boolean(environmentVariables.DB_AUTO_LOAD_ENTITIES),
    dropSchema: Boolean(environmentVariables.DB_DROP_SCHEMA),
  },
  aws: {
